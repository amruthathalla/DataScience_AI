...
import pandas as pd
import pickle
from flask import jsonify  # ← this is missing


app = Flask(__name__)

# Loading the Models and Results
...
results_df = pd.read_csv(r'c:\Users\Amrutha Thalla\FSDS\DataScience_AI\Machine Learning\Regression Project\model_evaluation_results.csv')
