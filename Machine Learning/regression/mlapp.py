...
model = pickle.load(open(r'C:\Users\Amrutha Thalla\FSDS\DataScience_AI\ML_Basics\salary prediction using linear regression algorithm\linear_regression_model.pkl', 'rb'))
...
years_experience = st.number_input("Enter Years of Experience:", min_value=0.0, max_value=50.0, step=0.5)
...
st.write("The model was trained using a dataset of salaries and years of experience built model by Amrutha")