...
model = pickle.load(open(r"C:\Users\Amrutha Thalla\FSDS\DataScience_AI\Machine Learning\salary_pred_using_linearregressionalgorithm\linear_regression_model.pkl", 'rb'))
